...
image_id = "SWASTIK_TVFVARS"
min_size = 2345
oke_network_vcn = true
vpc_name = "TFVARS VALUE"                     # Case where variable is not defined
subnet_name = "tf-0.12-rvt-example-subnet_TFVARS"
interface_ips = ["172.16.10.100", "TFVARS"]
